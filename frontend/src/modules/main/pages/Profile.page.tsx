...
export const ProfilePage = () => {
    ...
    return !getProfileQuery.isLoading &&
        <section
            className='relative gap-[26px] flex flex-col items-center justify-between md:justify-normal p-[26px] text-start md:rounded-[12px] md:top-1/2 md:-translate-y-1/2 md:left-1/2 md:-translate-x-1/2
